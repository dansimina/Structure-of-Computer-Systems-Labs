...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L xpm -L axis_infrastructure_v1_1_0 -L axis_data_fifo_v2_0_9 -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot  xil_defaultlib. xil_defaultlib.glbl -log elaborate.log
}
...
map_local_libs()
{
  ...
  local_libs=(axis_infrastructure_v1_1_0 axis_data_fifo_v2_0_9)
