...
#
# Generated by export_simulation on Sat Nov 30 22:19:49 +0200 2024
#
################################################################################
...
./tb_threshold_exceeding_comparator.sh
...
'-reset_run' switch to the './tb_threshold_exceeding_comparator.sh' script.

./tb_threshold_exceeding_comparator.sh -reset_run
...
./tb_threshold_exceeding_comparator.sh -noclean_files

For more information on the script, please type './tb_threshold_exceeding_comparator.sh -help'.
