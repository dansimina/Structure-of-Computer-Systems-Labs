...
#
# Generated by export_simulation on Thu Nov 07 13:17:58 +0200 2024
#
################################################################################
...
'-reset_run' switch to the './testbench_stimulus_file.sh' script.

./testbench_stimulus_file.sh -reset_run
...
./testbench_stimulus_file.sh -noclean_files

For more information on the script, please type './testbench_stimulus_file.sh -help'.
